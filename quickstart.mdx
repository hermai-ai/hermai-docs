...
Create a free account at [hermai.ai/register](https://hermai.ai/register). No credit card required — Phase 1 is fully free.
...
Discovered something useful? Push it to the registry so other agents can benefit:

```bash
# Install the CLI
go install github.com/hermai-ai/hermai-cli/cmd/hermai@latest

# Discover endpoints for a site (runs locally, may take 1-2 minutes)
...
You earn **+50 credits per site** for contributions. Credits become your starting balance when hosted execution launches in Phase 2.
