...
### Option 1: Use the CLI to discover and push

```bash
# Install the CLI
go install github.com/hermai-ai/hermai-cli/cmd/hermai@latest

# Discover endpoints (runs the engine locally)
...
The CLI handles the schema format automatically — you don't need to write JSON by hand.
