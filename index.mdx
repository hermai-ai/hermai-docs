...
Hermai is a schema registry and hosted fetch API for AI agents. Point an agent at any domain in the registry to find callable endpoints, then either execute the endpoint yourself or call Hermai's hosted `/v1/fetch` API for managed execution.
